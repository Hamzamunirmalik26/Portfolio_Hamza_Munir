...
*/
--------------------------------------------------------------------------------------------------------------------------
/* Data has 1000 columns and only 18 of them contain data . getting rid of other 982 empty columns 
 by first importing data into [data_table] table and using first 18 columns to create new table NashvilleHousing */
